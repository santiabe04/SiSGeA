...
export async function GET() {
  try {
    const result = await promisePool.query('SELECT * FROM measurement_units;')
...
export async function POST(req) {
  try {
    ...
    var result = await promisePool.query(`INSERT INTO measurement_units (${fields}) VALUES (${params});`);
